          ...
          <li class="mega-menu dropdown"><a>دسته ها</a>
            <div class="dropdown-menu">
                @foreach ($categories as $cat1)
                    <div class="column col-lg-2 col-md-3"><a href="category.html">{{$cat1->title}}</a>
                        <div>
                            <ul>
                                @foreach ($cat1->childs()->get() as $cat2)
                                    <li><a href="#"> {{$cat2->title}} <span>&rsaquo;</span></a>
                                        <div class="dropdown-menu">
                                            <ul>
                                                @foreach ($cat2->childs()->get() as $cat3)
                                                    <li><a href="#"> {{$cat3->title}} </a></li>
                                                @endforeach
                                            </ul>
                                        </div>
                                    </li>
